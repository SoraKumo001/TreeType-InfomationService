...
// Generated by dts-bundle v0.7.3
    ...
    export class PanelControl {
        static setControlValue(target: HTMLElement, name: string, value: string | number | boolean): void;
        static getControlValue(target: HTMLElement, name: string): string | boolean | null;
        static createControl(target: HTMLElement, param: PanelCreateParam): void;
    }
